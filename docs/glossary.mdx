...
- **ERC** (Ethereum Request for Comments) Generally refers the original proposal (which may be incomplete) that is eventually turned into an EIP. In common usage, it also refers to application level standards and conventions like token standards (e.g. ERC20) and URI schemes (e.g. ERC67)
